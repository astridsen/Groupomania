...
const signIn = () => {
  return (
	...
	<div class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
		<div>
            <img class="relative w-64" src={logo} alt="groupomanie-logo" />
			<h1 class="text-2xl font-bold text-center mb-4 cursor-pointer">Se connecter</h1>
		</div>
		<div class="space-y-4">
			...
			<div class="text-center mt-6">
				<button class="py-3 w-64 text-xl text-white bg-red-500 rounded-2xl">Se connecter</button>
			</div>
		</div>
